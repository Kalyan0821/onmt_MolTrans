...
from moltrans_onmt.utils.cnn_factory import shape_transform, GatedConv
...
class CNNDecoder(nn.Module):
    ...
    def __init__(
        ...
        for _ in range(self.num_layers):
            self.attn_layers.append(
                moltrans_onmt.modules.ConvMultiStepAttention(self.hidden_size)
            )
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None, step=None):
        ...
        #       with moltrans_onmt.modules.RNNDecoderBase.forward()
        # CHECKS
