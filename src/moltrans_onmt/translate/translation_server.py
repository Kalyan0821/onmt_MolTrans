...
import torch
from moltrans_onmt.translate.translator import build_translator
from moltrans_onmt.utils.logging import init_logger
...
class ServerModel:
    ...
    def parse_opt(self, opt):
        """Parse the option set passed by the user using `moltrans_onmt.opts`
        Args:
        ...
        moltrans_onmt.opts.translate_opts(parser)
