...
import moltrans_onmt.utils.distributed
from moltrans_onmt.train_single import main as single_main
...
def run(opt, device_id, error_queue):
    """run process"""
    try:
        gpu_rank = moltrans_onmt.utils.distributed.multi_init(opt, device_id)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="train.py", formatter_class=argparse.ArgumentDefaultsHelpFormatter
    )
