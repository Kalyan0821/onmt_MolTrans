...
from moltrans_onmt.decoders.cnn_decoder import CNNDecoder
from moltrans_onmt.decoders.decoder import InputFeedRNNDecoder, StdRNNDecoder
from moltrans_onmt.decoders.transformer import TransformerDecoder
from moltrans_onmt.encoders.audio_encoder import AudioEncoder
from moltrans_onmt.encoders.cnn_encoder import CNNEncoder
from moltrans_onmt.encoders.image_encoder import ImageEncoder
...
from moltrans_onmt.modules import CopyGenerator, Embeddings
from moltrans_onmt.utils.logging import logger
from moltrans_onmt.utils.misc import use_gpu
...
def build_base_model(model_opt, fields, gpu, checkpoint=None):
    ...
    model = moltrans_onmt.models.NMTModel(encoder, decoder)

    # Build Generator.
    if not model_opt.copy_attn:
        if model_opt.generator_function == "sparsemax":
            gen_func = moltrans_onmt.modules.sparse_activations.LogSparsemax(dim=-1)
        else:
