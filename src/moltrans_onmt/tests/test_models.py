...
import moltrans_onmt.opts
from moltrans_onmt.model_builder import build_embeddings, build_encoder, build_decoder
...
moltrans_onmt.opts.model_opts(parser)
moltrans_onmt.opts.train_opts(parser)
...
class TestModel(unittest.TestCase):
    ...
    def get_vocab(self):
        src = moltrans_onmt.inputters.get_fields("text", 0, 0)["src"]
        src.build_vocab([])
        return src.vocab
    ...
    def nmtmodel_forward(self, opt, source_l=3, bsize=1):
        ...
        model = moltrans_onmt.models.model.NMTModel(enc, dec)
...
if moltrans_onmt.models.sru.check_sru_requirement():
