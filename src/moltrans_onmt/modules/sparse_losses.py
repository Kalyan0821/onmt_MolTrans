...
from moltrans_onmt.modules.sparse_activations import threshold_and_support
...
class SparsemaxLoss(nn.Module):
    ...
    def __init__(self, weight=None, ignore_index=-100, reduce=True, size_average=True):
        self.weight = weight
