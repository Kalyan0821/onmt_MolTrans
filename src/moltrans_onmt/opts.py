...
import argparse
from moltrans_onmt.models.sru import CheckSRU
...
def model_opts(parser):
    ...
    group.add_argument(
        "-src_word_vec_size", type=int, default=500, help="Word embedding size for src."
    )
    group.add_argument(
        "-tgt_word_vec_size", type=int, default=500, help="Word embedding size for tgt."
    )
    group.add_argument(
        "-word_vec_size",
        type=int,
    ...
    group.add_argument(
        "-enc_layers", type=int, default=2, help="Number of layers in the encoder"
    )
    group.add_argument(
        "-dec_layers", type=int, default=2, help="Number of layers in the decoder"
    )
    group.add_argument(
        "-rnn_size",
        type=int,
    ...
    group.add_argument(
        "-brnn", action=DeprecateAction, help="Deprecated, use `encoder_type`."
    )
    ...
    group.add_argument(
        "-copy_attn_force", action="store_true", help="When available, train to copy."
    )
    group.add_argument(
        "-reuse_copy_attn",
        action="store_true",
    ...
    group.add_argument(
        "-coverage_attn", action="store_true", help="Train a coverage attention layer."
    )
    group.add_argument(
        "-lambda_coverage", type=float, default=1, help="Lambda value for coverage."
    )
...
def preprocess_opts(parser):
    ...
    group.add_argument(
        "-src_dir", default="", help="Source directory for image or audio files."
    )
    ...
    group.add_argument(
        "-dynamic_dict", action="store_true", help="Create dynamic dictionaries"
    )
    group.add_argument(
        "-share_vocab", action="store_true", help="Share source and target vocabulary"
    )

    # Truncation options, for text corpus
    group = parser.add_argument_group("Pruning")
    group.add_argument(
        "-src_seq_length", type=int, default=50, help="Maximum source sequence length"
    )
    group.add_argument(
    ...
    group.add_argument(
        "-log_file", type=str, default="", help="Output logs to a file under this path."
    )

    # Options most relevant to speech
    group = parser.add_argument_group("Speech")
    group.add_argument("-sample_rate", type=int, default=16000, help="Sample rate.")
    group.add_argument(
        "-window_size",
        type=float,
        default=0.02,
...
def train_opts(parser):
    ...
    group.add_argument(
        "-batch_size", type=int, default=64, help="Maximum batch size for training"
    )
    group.add_argument(
        "-batch_type",
        default="sents",
    ...
    group.add_argument(
        "-valid_steps", type=int, default=10000, help="Perfom validation every X steps"
    )
    group.add_argument(
        "-valid_batch_size",
        type=int,
    ...
    group.add_argument(
        "-epochs", type=int, default=0, help="Deprecated epochs see train_steps"
    )
    group.add_argument(
        "-optim",
        default="sgd",
    ...
    group.add_argument(
        "-truncated_decoder", type=int, default=0, help="""Truncated bptt."""
    )
    group.add_argument(
        "-adam_beta1",
        type=float,
    ...
    group.add_argument(
        "-decay_steps", type=int, default=10000, help="""Decay every decay_steps"""
    )
    ...
    group.add_argument(
        "-exp_host", type=str, default="", help="Send logs to this crayon server."
    )
    group.add_argument(
        "-exp", type=str, default="", help="Name of the experiment for logging."
    )
...
def translate_opts(parser):
    ...
    group.add_argument(
        "-min_length", type=int, default=0, help="Minimum prediction length"
    )
    group.add_argument(
        "-max_length", type=int, default=100, help="Maximum prediction length."
    )
    group.add_argument(
        "-max_sent_length",
    ...
    group.add_argument(
        "-beta", type=float, default=-0.0, help="""Coverage penalty parameter"""
    )
    group.add_argument(
        "-block_ngram_repeat",
        type=int,
    ...
    group.add_argument(
        "-attn_debug", action="store_true", help="Print best attn for each word"
    )
    group.add_argument(
        "-dump_beam", type=str, default="", help="File to dump beam information to."
    )
    group.add_argument(
        "-n_best",
        type=int,
